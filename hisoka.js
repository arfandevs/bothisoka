...
const Arfanthumb = await getBuffer('https://telegra.ph/file/019110c7ecbc463a32756.jpg')
wm = 'ArfanDevs Recode By arfan'
const fpayment = {
  key: {
    remoteJid: '6281410528015@s.whatsapp.net',
    fromMe: false,
    id: 'BAE595C600522C9C',
    participant: '6281410528015@s.whatsapp.net'
  },
  message: {
    "requestPaymentMessage": {
  "noteMessage": { extendedTextMessage: { text: `Lmao Banget Ngab` }},
  "currencyCodeIso4217": 'IDR',
  "currencyCode": 'Mau Apa Bang Di Arfan? Cie Anda Kang Copas Yahh Awokawok Tolol Luhh :v',
  "requestFrom": '6281410528015@s.whatsapp.net',
...
const ftroli = { key: { remoteJid: 'status@broadcast', participant: '6281410528015@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999999999999999999999999999999999999999999999999, status: 1, surface: 1, message: wm, orderTitle: wm, sellerJid: '6281410528015@s.whatsapp.net' } } }
const fkontak = { key: {participant: `6281410528015@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': wm, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${wm},;;;\nFN:${wm},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, 'jpegThumbnail': require('fs').readFileSync('./lib/hisoka.jpg'), thumbnail: require('fs').readFileSync('./lib/hisoka.jpg'),sendEphemeral: true}}}
const fvn = {
	 key: { 
          fromMe: false,
	      participant: `6281410528015@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "6281410528015@g.us" } : {}) 
                },
	 message: { 
		"audioMessage": {
...
const fliveLoc = {
	 ...
	 message: { "liveLocationMessage": { "caption":"©ArfanDevs","h": `${wm}`, 'jpegThumbnail': await hisoka.reSize(thumb2, 300, 300)}}
	}
const ftoko = {
key: {
			fromMe: false,
			participant: `6281410528015@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6282331033919@s.whatsapp.net" } : {})
		},
		message: {
			"productMessage": {
				"product": {
					...
					"title": arfan, //Kasih namalu 
					"description": `ARFANDEVS`,
					"currencyCode": "USD",
					"priceAmount1000": "20000000",
					"retailerId": "Ghost",
					"productImageCount": 1
				},
				    "businessOwnerJid": `6281410528015@s.whatsapp.net`
		}
	}
}
...
const fgclink = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6281410528015@g.us",
			"inviteCode": "null",
			"groupName": "Hisoka - Morou", 
            "caption": `Recode By Arfan`,
            'jpegThumbnail': await hisoka.reSize(thumb2, 300, 300)
		}
	}
}
    ...
    sourceUrl: ``
	    ...
	    break
           ...
           if (/image/.test(mime)) {
                ...
                let encmedia = await hisoka.sendImageAsSticker(m.chat, media, m, { packname: `${text1 ? '' + text1 : 'Create By Arfan'}`, author: `${text2 ? '' + text2 : '' }` })
                ...
                let media = await hisoka.downloadMediaMessage(qmsg)
                let encmedia = await hisoka.sendVideoAsSticker(m.chat, media, m, { packname: `${text1 ? '' + text1 : 'Create By Arfan'}`, author: `${text2 ? '' + text2 : '' }` })
                await fs.unlinkSync(encmedia)
            } else {
...
footer: `Simple whatsapp Bot Create By Arfan`,
title: "",
buttonText: "Ok",
sections
}
...
footer: `Simple whatsapp Bot - Create By ©AhmdArfan`,
title: "",
buttonText: "Klik!",
sections
}
...
hisoka.sendMessage(m.chat, listMessage, {quoted:m})
 ...
 fkntk = {key: {participant: `6281410528015@s.whatsapp.net`, ...(m.chat ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `Anda Mendapat pesan Menfess!!`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': global.thumb, thumbnail: global.thumb,sendEphemeral: true}}}
	   ...
	   case prefix+'yta': case prefix+'ytmp3': case prefix+'ytaudio': {
		...
		let urls = quoted.text.match(new RegExp(/(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/, 'gi'))
           ...
           case 'waifu2': case 'shota': case 'yotsuba': case 'shinomiya': case 'yumeko': case 'tejina': case 'chiho': case 'boruto': case 'kaori': case 'shizuka': case 'kaga': case 'kotori': case 'mikasa': case 'akiyama': case 'gremory': case 'isuzu': case 'shina': case 'kagura': case 'shinka': case 'eba': case 'elaina': case 'erza': case 'hinata': case 'minato': case 'naruto': case 'sagiri': case 'nezuko': case 'rize': case 'ana': case 'deidara': case 'yuki': case 'asuna': case 'ayuzawa': case 'chitoge': case 'emilia': case 'hestia': case 'inori': case 'itachi': case 'madara': case 'sakura': case 'sasuke': case 'tsunade': case 'onepiece': case 'mobil': case 'montor': case 'keneki': case 'toukachan': case 'akira': case 'itori': case 'kurumi': case 'loli': case 'pokemon': {
                hisoka.sendMessage(m.chat, waitv2, { quoted: m })
           let res = await fetchJson(`https://raw.githubusercontent.com/Arfangmntng/RESTAPI/master/data/${command}.json`)
...
case prefix+'gitclone': {
    if (!text) throw 'link githubnya mana? contoh: https://github.com/ArfanXyz/Hisoka-Morou'
 ...
 contextInfo: {   
    ...
    sourceUrl: `${res[0].link}`
      ...
      case 'ahegao': case 'pussy': case 'nsfwloli': case 'zettai': case 'foot': {
                hisoka.sendMessage(m.chat, waitv2, { quoted: m })
      let ris = await fetchJson(`https://raw.githubusercontent.com/Arfangmntng/RESTAPI/master/data/${command}.json`)
...
break
    ...
    let json = await fetchJson(`https://raw.githubusercontent.com/Arfangmntng/RESTAPI/master/data/kisahNabi/${command}.json`)   
...
const listMessage = {
text: `create by ©Arfan`,
footer: `textpro maker by Arfan scrape from exfarr-api`,
title: "",
